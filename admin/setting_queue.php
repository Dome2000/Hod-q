        ...
        <div class="con">
            <form action="#" method="post">
                <div class="input-group mb-3">
                    <select class="form-select" name="department" aria-describedby="button-addon2" required>
                    ...
                    <button class="btn btn-success" type="submit" id="button-addon2" name="dep">ตกลง</button>
                </div>
            </form><br>
            <?php
            if (isset($_POST['dep'])) {
            ...
            <div class="table-responsive">
                <table id="myTable" class="display" style="width: 100%;">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $sql = "SELECT queue.q_id, department.dp_name, queue.q_date, queue.q_time, queue.q_max, queue.sf_username, queue.dp_id FROM `queue` JOIN department ON queue.dp_id = department.dp_id ORDER BY queue.q_date DESC;";
