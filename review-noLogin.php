                ...
                success: function(data) {
                    ...
                    if (data.review_data.length > 0) {
                        ...
                        for (var count = 0; count < data.review_data.length; count++) {
                            ...
                            html += '<div class="row">';
                            html += '<div class="col-md-1 col-sm-4 col-xs-12"><div class="rounded-circle bg-danger text-white" style="height:55px; width:55px; padding-top:12px;"><h3 class="text-center">' + data.review_data[count].user_name.charAt(0) + '</h3></div>';
                            html += '</div>';
